...
- [x] **Step 1: Read the installed Next.js route-handler guide**
...
- [x] **Step 4: Implement POST and update the client**
...
- [x] **Step 5: Run route and brief tests and verify GREEN**
...
- [x] **Step 1: Write failing state and provenance tests**
...
- [x] **Step 3: Implement state and UI changes**
